...
BUTTON = [[Button.url("❓ What Is This", "https://t.me/Yumeko_Support_Chat/202")]]
...
MC = "https://telegra.ph/file/dd19164f6289d112e0eb3.mp4"
...
@asst.on(events.NewMessage(pattern="/madar ?(.*)"))
async def madar(e):
         user_id = e.sender.id
         user_name = e.sender.first_name
         mention = f"[{user_name}](tg://user?id={str(user_id)})"
         mm = random.randint(100,1000)
         MADAR = f"**🔥** {mention} **Is** {mm}**% Madarchod!**"
         await e.reply(MADAR, buttons=BUTTON, file=MC)
