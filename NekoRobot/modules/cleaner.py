...
for handler_list in NEKO_PTB.handlers:
    for handler in NEKO_PTB.handlers[handler_list]:
...
NEKO_PTB.add_handler(SET_CLEAN_BLUE_TEXT_HANDLER)
NEKO_PTB.add_handler(ADD_CLEAN_BLUE_TEXT_HANDLER)
NEKO_PTB.add_handler(REMOVE_CLEAN_BLUE_TEXT_HANDLER)
NEKO_PTB.add_handler(ADD_CLEAN_BLUE_TEXT_GLOBAL_HANDLER)
NEKO_PTB.add_handler(REMOVE_CLEAN_BLUE_TEXT_GLOBAL_HANDLER)
