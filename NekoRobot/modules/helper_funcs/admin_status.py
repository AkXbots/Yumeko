...
from telegram import Chat, Update, ChatMember, InlineKeyboardButton, InlineKeyboardMarkup, ParseMode
...
def user_is_admin(
	...
	chat = update.effective_chat
#    if chat.type == "private" or user_id in DRAGONS or user_id in DEV_USERS or chat.all_members_are_administrators
