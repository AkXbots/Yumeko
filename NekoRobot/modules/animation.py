...
NEKO_PTB.add_handler(KILL_HANDLER)
NEKO_PTB.add_handler(LOVE_HANDLER)
NEKO_PTB.add_handler(HACK_HANDLER)
NEKO_PTB.add_handler(BOMBS_HANDLER)
NEKO_PTB.add_handler(EARTHANIMATION_HANDLER)
NEKO_PTB.add_handler(MOONANIMATION_HANDLER)
