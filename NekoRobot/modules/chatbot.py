...
import NekoRobot.modules.sql.kuki_sql as sql
from NekoRobot import BOT_ID, BOT_NAME, BOT_USERNAME, NEKO_PTB
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "{} ᴄʜᴀᴛʙᴏᴛ ᴅɪsᴀʙʟᴇᴅ ʙʏ {}.".format(
                    NEKO_PTB.bot.first_name, mention_html(user.id, user.first_name)
                ),
...
@user_admin
@gloggable
def NekoRobotchatbot(update: Update, context: CallbackContext):
...
CHATBOTK_HANDLER = CommandHandler("chatbot", NekoRobotchatbot)
